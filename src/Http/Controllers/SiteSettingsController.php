...
class SiteSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.site');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.site.index", media:[
            "site_profile",
            "site_logo"
        ]);
    }
