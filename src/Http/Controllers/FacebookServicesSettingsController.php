...
class FacebookServicesSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.services-facebook');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.services-facebook.index", media:[]);
    }
}
