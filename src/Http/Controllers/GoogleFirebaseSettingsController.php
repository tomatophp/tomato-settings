...
class GoogleFirebaseSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.google-firebase');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.google-firebase.index", media:[
            'google_firebase_cr'
        ]);
    }
}
