...
class AddThisServicesSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.services-addthis');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.services-addthis.index", media:[]);
    }
}
