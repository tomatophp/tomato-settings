...
class ShippingServicesSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.services-shipping');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.services-shipping.index", media:[]);
    }
}
