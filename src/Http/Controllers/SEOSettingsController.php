...
class SEOSettingsController extends Setting
{
    ...
    {
        return $this->get(request: $request, view:'tomato-settings::settings.seo');
    }
    ...
    {
        return $this->save(request: $request, redirect: "admin.settings.seo.index", media:[
            "site_profile",
            "site_logo"
        ]);
    }
